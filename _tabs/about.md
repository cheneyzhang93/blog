...
- **职场治理**：低管理能力环境下的入职与带人——新人自己发起的信息采集、职责对齐与信号机制，以及带人这一端 22 个当场要用的判断。
...
- [《带人场景手册：22 个当场要用的判断》]({{ '/posts/people-management-playbook/' | relative_url }})——按现象查的场景页，每节给第一步、话术和「怎么算做对了」，附 14 张可以直接抄的表；
- [《入职上手 SOP：信息采集、职责对齐与信号机制》]({{ '/posts/newcomer-onboarding-sop/' | relative_url }})——新人这一端：三无环境里的五个节点、四份模板与适用边界。
